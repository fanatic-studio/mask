...
public class VDMask extends WXVContainer<VDMaskLayout> implements View.OnClickListener {
    private VDMaskLayout mContainer;
    ...
    public VDMask(WXSDKInstance instance, WXVContainer parent, BasicComponentData basicComponentData) {
    ...
    @Override
    protected VDMaskLayout initComponentHostView(Context context) {
        mContainer = new VDMaskLayout(context);
    ...
    private class MaskAnimationListener implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            VDMask.this.getHostView().setAlpha(alpha);
        }
    ...
    private class MaskShowListener implements ValueAnimator.AnimatorListener {
        ...
        public void onAnimationStart(Animator animation) {
            ...
            if (getChildCount() > 0) {
                ...
                if (child instanceof VDPop) {
                    if (mSubComponent == null) {
                        mSubComponent = (VDPop) child;
                    }
